-- =========================================
-- 🚀 SEED DATA V5 - AVEC SUPPORT I18N
-- =========================================
-- Ce script inclut :
-- 1. Migration pour les colonnes i18n (JSONB)
-- 2. Données produits avec traductions EN
-- 3. Données news et topics
-- =========================================
...
-- ============================
-- 📦 SEED — PRODUCTS AVEC I18N
-- ============================

INSERT INTO public.products (name, name_i18n, dosage, category, category_i18n, price, sale_price, is_on_sale, stock, purity, image, tags, description, description_i18n)
VALUES
