...
export const EMAIL_ASSETS = {
  'cart-abandoned': 'https://dwomsbawthlktapmtmqu.supabase.co/storage/v1/object/public/email-assets/cart-abandoned.png',
  'email-verify': 'https://dwomsbawthlktapmtmqu.supabase.co/storage/v1/object/public/email-assets/email-verify.png',
  'loyalty': 'https://dwomsbawthlktapmtmqu.supabase.co/storage/v1/object/public/email-assets/loyalty.png',
  'order-confirmed': 'https://dwomsbawthlktapmtmqu.supabase.co/storage/v1/object/public/email-assets/order-confirmed.png',
