...
export default {
  ...
  home: {
    ...
    quality: {
      ...
      features: {
        f1: {
          title: 'Contrôle pureté',
          description: 'Analyse HPLC et LC-MS pour chaque lot.',
        },
        f2: {
          title: 'Traçabilité complète',
          description: 'Suivi de la synthèse à la livraison.',
        },
        f3: {
          title: 'Expédition sécurisée',
          description: 'Emballage optimisé pour la conservation.',
        },
        f4: {
          title: 'Support technique',
          description: 'Équipe dédiée pour vos questions.',
        },
      },
    },
    faq: {
      ...
      items: {
        ...
        q3: {
          ...
          a: 'Les commandes validées avant 14h sont expédiées le jour même. Livraison en 24-48h en France, 2-4 jours en Europe.',
        },
        q4: {
        ...
        q5: {
          ...
          a: 'Oui, nous servons les laboratoires, instituts de recherche et entreprises pharmaceutiques. Contactez-nous pour un devis personnalisé.',
        },
      },
    },
    cta: {
    ...
    banner: {
      ...
      bullets: {
        ...
        b2: 'Ressources externes sélectionnées : articles, vidéos, revues.',
        b3: 'Rappel constant : recherche exclusivement – aucun usage humain.',
      },
      cta: 'Explorer les ressources',
      carousel: {
        protocols: 'Notre catalogue',
        guides: 'Guides protocoles',
        scientific: 'Contenu scientifique non médical.',
      },
      personas: {
        rd: {
          title: 'Recherche R&D',
          subtitle: 'Équipe R&D pharmaceutique',
        },
        lab: {
          title: 'Laboratoire',
          subtitle: 'Responsable labo académique',
        },
        phd: {
          title: 'Doctorant',
          subtitle: 'Projet thèse sciences',
        },
        quality: {
          title: 'Qualité',
    ...
    categories: {
      ...
      recovery: {
        ...
        description: 'BPC-157 et TB-500 : le duo pour la réparation tissulaire et la récupération accélérée.',
      ...
      growth: {
        ...
        description: "CJC-1295, GHRP-6, Ipamorelin : stimulation de l'axe GH/IGF-1 pour la croissance.",
      ...
      antiAging: {
        ...
        description: 'Sermorelin et NAD+ : restauration des niveaux de GH et soutien de la réparation cellulaire.',
      ...
      performance: {
        ...
        description: 'PEG-MGF : facteur de croissance mécanique pour la réparation des fibres musculaires.',
        videoLabel: 'MGF & performance',
        stat1Label: 'Pureté HPLC',
        stat2Label: 'Livraison UE',
      },
      wellbeing: {
      ...
      nootropic: {
        ...
        description: "Selank et Semax : peptides nootropiques pour la mémoire et le focus.",
      ...
      cosmetic: {
        ...
        description: "GHK-Cu : peptide cuivré pour la synthèse de collagène et l'élasticité cutanée.",
      ...
      health: {
        ...
        description: "Thymosin Alpha-1 : modulation immunitaire et soutien des défenses naturelles.",
